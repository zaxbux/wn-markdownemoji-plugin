...
namespace Zaxbux\MarkdownEmoji\Classes;
...
class EmojiLibrary {
	const SHORTCODES = [
		...
		'male_red_haired' => '1F468-200D-1F9B0',
		'male_curly_haired' => '1F468-200D-1F9B1',
		'male_bald' => '1F468-200D-1F9B2',
		'male_white_haired' => '1F468-200D-1F9B3',
		...
		'female_red_haired' => '1F469-200D-1F9B0',
		'female_curly_haired' => '1F469-200D-1F9B1',
		'female_bald' => '1F469-200D-1F9B2',
		'female_white_haired' => '1F469-200D-1F9B3',
	...
	private static function joinCodes($hex) {
	...
	public static function replaceShortcodes($text) {
		...
		foreach ($emojis[1] as $shortcode) {
  		if (isset(EmojiLibrary::SHORTCODES[$shortcode])) {
    		$text = str_replace(":".$shortcode.":", EmojiLibrary::joinCodes(EmojiLibrary::SHORTCODES[$shortcode]), $text);
			}
		}
